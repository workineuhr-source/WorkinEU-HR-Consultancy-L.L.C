  ...
  return (
    ...
    >
      ...
      <div className="p-10 flex flex-col flex-grow relative">
        <div className="absolute top-0 right-10 -translate-y-1/2 w-16 h-16 bg-brand-gold text-slate-900 rounded-2xl flex items-center justify-center shadow-2xl group-hover:rotate-12 transition-transform duration-500">
          <ArrowRight size={28} />
        </div>

        <h3 className="text-3xl font-bold text-slate-900 mb-6 group-hover:text-brand-gold transition-colors leading-[1.1] tracking-tighter font-serif">
          {post.title}
        </h3>
        ...
        <div className="flex items-center justify-between pt-8 border-t border-slate-50">
          <span className="text-slate-900 font-bold text-xs uppercase tracking-[0.3em] group-hover:text-brand-gold transition-colors">
            Read Full Story
          </span>
