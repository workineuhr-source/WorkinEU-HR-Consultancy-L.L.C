...
export default function AdminDashboard() {
  ...
  return (
    <div className="h-screen bg-gray-50 dark:bg-slate-950 flex overflow-hidden transition-colors duration-500">
      ...
      <aside
        className={cn(
          "bg-[#121212] text-white w-72 h-full flex flex-col fixed inset-y-0 left-0 z-50 transition-all duration-300 transform lg:static lg:translate-x-0 border-r border-white/5 shadow-2xl shrink-0 overflow-hidden",
          isSidebarOpen ? "translate-x-0" : "-translate-x-full",
        )}
      >
        <div className="p-8 flex items-center justify-between border-b border-white/5 shrink-0 bg-[#121212]">
          <Link to="/" className="flex items-center gap-4 group">
            ...
            <div>
              <span className="block font-sans text-xl font-black tracking-tight">
                WorkinEU <span className="text-brand-teal">HR</span>
              </span>
              <span className="block text-[8px] uppercase tracking-[0.4em] text-brand-teal font-black opacity-80">
                Admin Core
              </span>
            </div>
          </Link>
          <button
            onClick={() => setIsSidebarOpen(false)}
            className="lg:hidden text-slate-500 hover:text-brand-teal transition-colors"
          >
            <X size={24} />
          </button>
        </div>
        ...
        <div className="flex-grow overflow-y-auto px-4 py-8 scrollbar-hide space-y-12">
          <div className="px-4">
            ...
            <Link
              to="/"
              className="flex items-center gap-4 px-6 py-4 rounded-2xl bg-brand-teal text-[#121212] hover:bg-white transition-all font-black text-xs uppercase tracking-widest shadow-lg shadow-brand-teal/20"
            >
              <RotateCcw size={18} />
              Return to Website
            </Link>
          ...
          <div>
            <p className="px-8 text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] mb-6">
              Management
            </p>
        ...
        <div className="p-6 space-y-4 border-t border-white/5 shrink-0 bg-[#121212]">
          <Link
            to="/"
          ...
          <div className="flex items-center gap-4 md:gap-8">
            <div className="flex items-center gap-2">
              <button className="p-3 text-gray-400 dark:text-gray-500 hover:text-brand-blue dark:hover:text-white hover:bg-gray-50 dark:hover:bg-white/5 rounded-xl relative transition-all group">
                ...
                <div className="absolute top-full right-0 mt-2 w-64 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-white/10 p-4 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                  <p className="text-xs font-bold text-brand-blue dark:text-brand-gold uppercase tracking-widest mb-2">
                    Notifications
                  </p>
            ...
            >
              <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-brand-blue dark:text-white group-hover:text-brand-gold transition-colors">
                  WorkinEU Admin
                </p>
