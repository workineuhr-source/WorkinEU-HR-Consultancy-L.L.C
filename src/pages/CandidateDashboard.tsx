...
export default function CandidateDashboard() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      fetchRecommendations(
        profileDoc.exists()
          ? ({ uid: profileDoc.id, ...profileDoc.data() } as CandidateProfile)
          : null,
      );
    } catch (error) {
  ...
  const handleCandidateDocumentUpload = (
  ...
  const handleAddDocument = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewDoc({ name: "", url: "", type: "CV", uploadMethod: "file" });
  ...
  const handleDeleteAlert = async (alertId: string) => {
    ...
    try {
      const updatedAlerts = (profile.jobAlerts || []).filter(
        (a) => a.id !== alertId,
      );
      await updateDoc(doc(db, "candidates", auth.currentUser.uid), {
        jobAlerts: updatedAlerts,
  ...
  const handleAgreeToRefund = async () => {
    ...
    try {
      ...
      toast.success(
        "You have agreed to the refund proposal. Admin will start processing.",
      );
    } catch (error) {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-950 p-4">
        <div className="text-center bg-white dark:bg-slate-900 p-12 rounded-3xl shadow-xl max-w-md border border-gray-100 dark:border-white/5">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-8">
            We couldn't find your candidate profile. Please try logging in
            again.
          </p>
          <button
            onClick={() => navigate("/")}
          ...
          <div className="hidden lg:block lg:col-span-1 space-y-6">
            <div className="bg-white dark:bg-[#121212] rounded-[3rem] shadow-xl border border-gray-100 dark:border-white/5 overflow-hidden transition-all duration-500">
              <div className="p-10 text-center bg-[#121212] text-white relative">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-brand-teal text-[10px] font-black uppercase tracking-[0.2em] mt-2">
                    Candidate Profile
                  </p>
                </div>
              </div>
            ...
            <div className="bg-[#121212] rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden border border-white/5 group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-200 text-sm mb-8 font-medium leading-relaxed">
                  Our world-class support team is here to assist your global
                  journey.
                </p>
                <a
                  href={whatsappLink}
              ...
              {activeTab === "overview" && (
                ...
                >
                    ...
                    <div className="md:col-span-2 bg-white dark:bg-[#0f172a] p-10 rounded-[3rem] shadow-premium border border-slate-100 dark:border-white/5 relative overflow-hidden group">
                      ...
                      <div className="relative z-10">
                        <div className="flex justify-between items-end mb-8">
                          <div>
                            <p className="text-[10px] font-black text-slate-400 dark:text-brand-teal uppercase tracking-[0.3em] mb-2">
                              Talent Readiness Index
                            </p>
                            <h4 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight">
                              Profile Integrity
                            </h4>
                          </div>
                          <p className="text-5xl md:text-7xl font-black text-brand-teal">
                          ...
                          {calculateCompleteness() < 100 ? (
                            <p className="text-sm font-bold text-slate-600 dark:text-slate-300 flex items-center gap-3">
                              ...
                              {calculateCompleteness() < 50
                                ? "Finalize experience metadata"
                                : "Add professional skills and imagery"}{" "}
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-brand-blue/60">
                            Having a photo increases your selection chances by
                            40%.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-400 dark:text-gray-500">
                            AI-powered suggestions based on your profile and
                            interests
                          </p>
                        </div>
                      </div>
                      ...
                      {loadingRecommendations ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                          {[1, 2, 3].map((i) => (
                            <div
                              key={i}
                              className="bg-gray-50 dark:bg-slate-800 rounded-3xl h-[400px] animate-pulse"
                            ></div>
                          ))}
                        </div>
                      ) : (
                    ...
                    <div className="bg-brand-gold/10 dark:bg-brand-gold/5 p-8 rounded-3xl border border-brand-gold/20 dark:border-brand-gold/10 shadow-sm">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="flex items-center gap-6">
                          ...
                          <div>
                            <h3 className="text-2xl font-bold text-brand-blue dark:text-white mb-1">
                              Online Interview Scheduled
                            </h3>
                            <p className="text-brand-blue/60 dark:text-white/60 font-medium">
                              For{" "}
                              <span className="text-brand-blue dark:text-brand-gold font-bold">
                                {profile.interviewPosition}
                              </span>{" "}
                              in{" "}
                              <span className="text-brand-blue dark:text-brand-gold font-bold">
                                {profile.interviewCountry}
                              </span>
                            </p>
                          </div>
                        </div>
                        <div className="flex flex-col sm:flex-row items-center gap-6">
                          <div className="text-left md:text-right">
                            ...
                            <p className="text-lg font-bold text-brand-blue dark:text-white">
                              {profile.interviewDate} at {profile.interviewTime}
                            </p>
                          </div>
                          <a
                  ...
                  <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5">
                    <h3 className="text-xl font-bold text-brand-blue dark:text-white mb-6">
                      Processing & Deployment Status
                    </h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                      <div className="flex items-center gap-4">
                        <div
                          className={cn(
                            ...
                            profile.documentProcessingStatus === "completed"
                              ? "bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400"
                              : profile.documentProcessingStatus ===
                                  "in-progress"
                        ...
                        <div>
                          ...
                          <p className="text-base md:text-lg font-bold text-brand-blue dark:text-white capitalize">
                        ...
                        <div
                          className={cn(
                            ...
                            profile.workPermitStatus === "approved"
                              ? "bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400"
                              : profile.workPermitStatus === "rejected"
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-base md:text-lg font-bold text-brand-blue dark:text-white">
                      ...
                      {applications.length === 0 ? (
                        <div className="p-12 text-center">
                          ...
                          <button
                            ...
                            className="mt-4 text-brand-blue dark:text-brand-gold font-bold hover:underline"
                          >
                            Browse Jobs
                          </button>
                        </div>
                ...
                >
                    ...
                    <div className="flex gap-4 items-center">
                      <div className="hidden sm:block text-right">
                        ...
                        <p className="text-[10px] text-gray-400 dark:text-gray-500">
                          Use Google Drive links for faster processing
                        </p>
                      </div>
                      <button
                  ...
                  <div className="bg-brand-blue/5 dark:bg-slate-900 border border-brand-blue/10 dark:border-white/5 p-6 rounded-3xl">
                    ...
                    <p className="mt-4 text-xs text-brand-blue dark:text-brand-gold font-bold italic">
                      Note: Basic English Speaking is Required for All
                      Positions.
                    </p>
                  </div>
                  ...
                  {isAddingDoc && (
                    ...
                    >
                      ...
                      >
                        <div className="col-span-1 md:col-span-3 mb-2 flex gap-4">
                          <button
                            type="button"
                            onClick={() =>
                              setNewDoc({
                        ...
                        <div className="md:col-span-1 flex items-end gap-3">
                          ...
                          <div className="flex gap-2">
                            <button
                              type="submit"
                              className="bg-[#0a192f] dark:bg-brand-gold text-white dark:text-brand-blue p-3 rounded-xl hover:scale-110 transition-all shadow-lg"
                            >
                              <CheckCircle2 size={24} />
                            </button>
                            <button
                              ...
                              className="bg-gray-100 dark:bg-slate-800 text-gray-500 dark:text-gray-400 p-3 rounded-xl hover:bg-gray-200 dark:hover:bg-slate-700 transition-all"
                            >
                              <X size={24} />
                            </button>
                          </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {profile.documents?.length === 0 ? (
                      ...
                      profile.documents?.map((doc, index) => (
                        <div
                          key={index}
                          className="bg-white dark:bg-slate-900 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5 flex items-center justify-between group hover:shadow-xl transition-all"
                        >
                          <div className="flex items-center gap-4">
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5 overflow-hidden">
                    {applications.length === 0 ? (
                      <div className="p-20 text-center">
                        ...
                        <button
                          onClick={() => navigate("/jobs")}
                          className="mt-6 bg-brand-blue dark:bg-brand-gold text-white dark:text-brand-blue px-8 py-3 rounded-xl font-bold hover:scale-105 transition-all"
                        >
                          Browse Jobs
                        </button>
                      </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5 border-t-4 border-t-brand-blue">
                      ...
                      <p className="text-3xl font-bold text-brand-blue dark:text-white">
                        {CURRENCY_SYMBOLS[profile.paymentCurrency || "EUR"]}{" "}
                        {calcTotalAmount}
                      </p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-blue-50/50 dark:bg-blue-900/10 p-8 rounded-[2.5rem] border border-blue-100 dark:border-blue-900/30">
                      ...
                      <ul className="space-y-3">
                        ...
                        {(!profile.includedPackageItems ||
                          profile.includedPackageItems.filter((i) => i.trim())
                            .length === 0) && (
                          <li className="text-xs text-slate-400 italic">
                            No specific items listed as included.
                          </li>
                        )}
                      </ul>
                    </div>
                    ...
                    <div className="bg-red-50/50 dark:bg-red-900/10 p-8 rounded-[2.5rem] border border-red-100 dark:border-red-900/30">
                      <h4 className="text-xs font-black text-red-600 dark:text-red-400 uppercase tracking-[0.2em] mb-6 flex items-center gap-2">
                        <ArrowUp size={16} className="rotate-45" /> Candidate
                        Must Pay
                      </h4>
                      <ul className="space-y-3">
                        {profile.excludedPackageItems
                          ?.filter((i) => i.trim())
                          .map((item, i) => (
                            <li
                              key={i}
                        ...
                        {(!profile.excludedPackageItems ||
                          profile.excludedPackageItems.filter((i) => i.trim())
                            .length === 0) && (
                          <li className="text-xs text-slate-400 italic">
                            No specific items listed as excluded.
                          </li>
                        )}
                      </ul>
                    </div>
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5 overflow-hidden">
                    <div className="p-8 border-b border-gray-50 dark:border-white/5 flex items-center justify-between">
                      ...
                      <button className="text-xs font-bold text-brand-gold uppercase tracking-widest hover:underline">
                        Download Statements
                      </button>
                    </div>
                    <div className="p-0">
                          ...
                          <table className="w-full text-left">
                            <thead className="bg-gray-50 dark:bg-slate-800 text-gray-400 dark:text-gray-500 text-xs font-bold uppercase tracking-widest">
                              <tr>
                                ...
                                <th className="px-8 py-4">Method & Ref</th>
                            ...
                            <tbody className="divide-y divide-gray-50 dark:divide-white/5">
                              {profile.paymentHistory.map((payment, i) => (
                                <tr
                                  ...
                                  className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors"
                                >
                                  <td className="px-8 py-6 text-sm font-bold text-brand-blue dark:text-white">
                                    {payment.date}
                                  </td>
                                  <td className="px-8 py-6 text-sm text-gray-500 dark:text-gray-400 font-medium">
                                    {payment.method}
                                    {payment.transactionId && (
                                      <div className="text-[10px] text-gray-400/80 mt-1 uppercase font-mono">
                                        {payment.transactionId}
                                      </div>
                                    )}
                                  </td>
                  ...
                  <div className="bg-brand-blue/5 dark:bg-brand-gold/5 p-8 rounded-3xl border border-brand-blue/10 dark:border-brand-gold/10">
                    <div className="flex items-start gap-4">
                      ...
                      />
                      <div>
                        <h4 className="font-bold text-brand-blue dark:text-brand-gold mb-2">
                          Payment Information
                        </h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed font-medium">
                          All payments are recorded and tracked in our system.
                          If you have made a payment that is not reflected here,
                          please contact our support team with your receipt.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  {!profile.refundRequest ? (
                    <div className="bg-white dark:bg-slate-900 p-20 text-center rounded-3xl border border-gray-100 dark:border-white/5 shadow-sm">
                      <RotateCcw
                        ...
                        size={64}
                      />
                      <h4 className="text-xl font-bold text-brand-blue dark:text-white mb-2">
                        No Refund Requests
                      </h4>
                      <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto font-medium">
                        If you wish to cancel your application and request a
                        refund, you can do so here.
                      </p>
                      <button
                        onClick={() => navigate("/")}
                        className="mt-8 text-brand-blue dark:text-brand-gold font-bold hover:underline flex items-center gap-2 mx-auto"
                      >
                      ...
                      <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5">
                        <div className="flex flex-col md:flex-row justify-between gap-6 mb-8">
                          <div className="flex items-center gap-6">
                            <div
                              className={cn(
                                ...
                                profile.refundRequest.status === "pending"
                                  ? "bg-orange-50 text-orange-600 dark:bg-orange-900/20"
                                  : profile.refundRequest.status === "proposed"
                                    ? "bg-blue-50 text-blue-600 dark:bg-blue-900/20"
                                    : profile.refundRequest.status === "agreed"
                            ...
                            <div>
                              <div className="flex items-center gap-3 mb-1">
                                <h4 className="text-2xl font-bold text-brand-blue dark:text-white">
                                  Refund #{profile.refundRequest.id}
                                </h4>
                                <span
                                  className={cn(
                                    "px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest",
                              ...
                              <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">
                                Requested on{" "}
                                {new Date(
                                  profile.refundRequest.createdAt,
                                ).toLocaleDateString()}
                              </p>
                            </div>
                          </div>
                          <div className="text-left md:text-right">
                            ...
                            <p className="text-3xl font-bold text-brand-blue dark:text-white">
                              € {profile.refundRequest.totalReceivedAmount}
                            </p>
                          </div>
                        </div>

                        <div className="p-6 bg-gray-50 dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-white/5 mb-8">
                          <h5 className="font-bold text-brand-blue dark:text-white mb-2">
                            Reason for Request:
                          </h5>
                          <p className="text-gray-600 dark:text-gray-400 text-sm italic font-medium">
                            "{profile.refundRequest.reason}"
                          </p>
                        </div>
                          ...
                          <div className="bg-brand-blue/5 dark:bg-slate-900 p-8 rounded-3xl border border-brand-blue/10 dark:border-white/5 mb-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                              <div>
                                ...
                                <p className="text-xl font-bold text-brand-blue dark:text-white">
                                  € {profile.refundRequest.totalReceivedAmount}
                                </p>
                              </div>
                              <div>
                                <p className="text-xs font-bold text-red-400 uppercase tracking-widest mb-1">
                                  Risk Amount (Deduction)
                                </p>
                                <p className="text-xl font-bold text-red-500">
                                  - € {profile.refundRequest.riskAmount}
                                </p>
                              </div>
                              <div className="p-4 bg-white dark:bg-slate-800 rounded-2xl border border-brand-blue/10 dark:border-white/5 shadow-sm">
                                <p className="text-xs font-bold text-green-500 dark:text-green-400 uppercase tracking-widest mb-1">
                                  Refundable Amount
                                </p>
                                <p className="text-2xl font-bold text-green-600 dark:text-green-300">
                                  € {profile.refundRequest.refundableAmount}
                                </p>
                              </div>
                            </div>
                            <div className="flex flex-col sm:flex-row items-center gap-4">
                              ...
                              <p className="text-xs text-gray-400 dark:text-gray-500 italic font-medium">
                                By clicking agree, you accept the deduction and
                                the refund processing terms.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        {(profile.refundRequest.status === "agreed" ||
                          profile.refundRequest.status === "processing" ||
                          profile.refundRequest.status === "completed") && (
                          <div className="space-y-8">
                            <div className="bg-indigo-50 dark:bg-indigo-950/20 p-8 rounded-3xl border border-indigo-100 dark:border-indigo-900/30">
                              ...
                              <p className="text-indigo-700 dark:text-indigo-400 text-sm mb-6 font-medium">
                                ...
                                is being processed. As per our policy, this will
                                be completed within{" "}
                                <span className="font-bold">90 days</span> in{" "}
                                <span className="font-bold">
                                  3 installments
                                </span>
                                .
                              ...
                              <div className="space-y-4">
                                {profile.refundRequest.installments.map(
                                  (inst, i) => (
                                    <div
                                      key={i}
                                      className="flex items-center justify-between p-4 bg-white dark:bg-slate-900 rounded-2xl border border-indigo-100 dark:border-white/5 shadow-sm"
                                    >
                                      <div className="flex items-center gap-4">
                                        <div
                                          className={cn(
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              type="submit"
                              className="bg-brand-blue dark:bg-brand-gold text-white dark:text-brand-blue p-3 rounded-xl hover:scale-105 transition-all"
                            >
                              <CheckCircle2 size={24} />
                            </button>
                            <button
                  ...
                  <div className="bg-brand-blue/5 dark:bg-brand-gold/5 p-8 rounded-3xl border border-brand-blue/10 dark:border-brand-gold/10">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed font-medium">
                          We'll notify you via email whenever a new job matches
                          your preferences. You can create multiple alerts for
                          different countries or roles.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      ...
                      <div className="flex-grow text-center md:text-left">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 font-medium">
                          Upload a professional photo to make your profile stand
                          out to employers. Max size 2MB.
                        </p>
                          ...
                          <div className="flex bg-gray-50 dark:bg-slate-800 p-1 rounded-xl">
                            <button
                              ...
                              className={cn(
                                ...
                                profile.cvPhotoStyle === "square" ||
                                  !profile.cvPhotoStyle
                                  ? "bg-white dark:bg-slate-700 shadow-sm text-brand-blue dark:text-white"
                                  : "text-gray-400",
                              )}
                            >
                              Square
                  ...
                  <div className="bg-white dark:bg-slate-900 p-8 md:p-10 rounded-3xl shadow-sm border border-gray-100 dark:border-white/5">
                    <form onSubmit={handleUpdateProfile} className="space-y-8">
                      <div className="pt-4 pb-8 border-b border-gray-100 dark:border-white/5">
                        <label className="block text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-4">
                      ...
                      <div className="pt-8 border-t border-gray-100 dark:border-white/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                          ...
                          <div className="md:col-span-2 lg:col-span-3">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                              {(profile.childrenNames || []).map(
                                (child, idx) => (
                                  <div key={idx} className="relative">
                                    <Baby
                                      className="absolute left-4 top-1/2 -translate-y-1/2 text-brand-teal"
                                      size={18}
                                    />
                                    <input
                                      type="text"
                      ...
                      <div className="pt-8 border-t border-gray-100 dark:border-white/5">
                        <div className="flex justify-between items-center mb-6">
                          <h4 className="text-lg font-bold text-brand-blue dark:text-white">
                            Skills & Expertise
                          </h4>
                          <button
                            type="button"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {(profile.skills || []).map((skill, index) => (
                            <div
                              key={index}
                              className="flex gap-3 items-start bg-gray-50 dark:bg-slate-800 p-4 rounded-2xl border border-gray-100 dark:border-white/5"
                            >
                          ...
                          {(profile.skills || []).length === 0 && (
                            <p className="col-span-full text-center py-8 text-gray-400 dark:text-gray-500 text-sm font-medium bg-gray-50 dark:bg-slate-800 rounded-2xl border border-dashed border-gray-200 dark:border-white/5">
                              No skills added yet. Add your professional skills
                              to stand out.
                            </p>
                          )}
                        </div>
                          ...
                          {(profile.languages || []).map((lang, index) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-2">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      newLangs[index].proficiency = parseInt(
                                        e.target.value,
                                      );
                                      // Bonus: Auto-set level based on proficiency if it's currently a default
                                      const val = parseInt(e.target.value);
                                      if (val >= 90)
                                        newLangs[index].level = "Native";
                                      else if (val >= 70)
                                        newLangs[index].level = "Fluent";
                                      else if (val >= 40)
                                        newLangs[index].level =
                                          "Conversational";
                              ...
                              <button
                                type="button"
                                onClick={() => {
                                  const newLangs = profile.languages?.filter(
                                    (_, i) => i !== index,
                                  );
                                  setProfile({
                                    ...profile,
                      ...
                      <div className="pt-8 border-t border-gray-100 dark:border-white/5">
                        ...
                        <div className="space-y-4">
                          {(profile.workHistory || []).map((work, index) => (
                            <div
                              key={index}
                              className="p-6 bg-gray-50 dark:bg-slate-800 rounded-3xl border border-gray-100 dark:border-white/5 space-y-4"
                            >
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <input
                                  type="text"
                              ...
                              <button
                                type="button"
                                onClick={() => {
                                  const newWork = profile.workHistory?.filter(
                                    (_, i) => i !== index,
                                  );
                                  setProfile({
                                    ...profile,
                            ...
                            (edu, index) => (
                              ...
                              >
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    const newEdu =
                                      profile.educationHistory?.filter(
                                        (_, i) => i !== index,
                                      );
                                    setProfile({
                                      ...profile,
                      ...
                      <div className="pt-8 border-t border-gray-100 dark:border-white/5">
                        <h4 className="text-lg font-bold text-brand-blue dark:text-white mb-6">
                          Processing & Deployment Information
                        </h4>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                          <div>
                            <label className="block text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2">
                        ...
                        <p className="text-xs text-gray-400 dark:text-gray-500 mt-4 italic">
                          * This information is updated by the WorkinEU HR team.
                        </p>
                      </div>
              ...
              <div className="space-y-8">
                ...
                {selectedJob && (
                  <div className="bg-brand-gold/5 dark:bg-brand-gold/10 border border-brand-gold/20 dark:border-brand-gold/30 p-6 rounded-2xl">
                    ...
                    selectedJob.requiredDocuments.length > 0 ? (
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {selectedJob.requiredDocuments.map((doc, i) => (
                          <div
                            key={i}
                            className="flex items-center gap-2 text-sm text-brand-blue dark:text-brand-gold font-bold bg-white dark:bg-slate-900 p-3 rounded-xl border border-brand-gold/10 dark:border-white/5 shadow-sm"
                          >
                            <CheckCircle2
                              size={16}
                              className="text-brand-gold"
                ...
                <div>
                  <h4 className="font-bold text-brand-blue dark:text-white mb-4">
                    ...
                    {selectedApp.documents.map((doc, i) => (
                      ...
                      >
                        ...
                        <div className="overflow-hidden">
                          <p className="text-sm font-bold text-brand-blue dark:text-white truncate">
                            {doc.name}
                          </p>
                ...
                <div className="pt-6 border-t border-gray-100 dark:border-white/10">
                  <h4 className="font-bold text-brand-blue dark:text-white mb-2">
                    Cover Letter
                  </h4>
