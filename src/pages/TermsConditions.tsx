  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        if (docRef.exists()) {
          const data = docRef.data() as SystemSettings;
          if (data.legalContent?.termsConditions) {
            setContent(data.legalContent.termsConditions);
          }
        }
      } catch (e) {
        console.error(e);
          ...
          {content ? (
            ...
            <>
              ...
              <section className="mb-10">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  WorkinEU HR Consultancy LLC provides recruitment consultancy, visa
                  assistance, and documentation support for individuals seeking
                  employment in Europe. We do not guarantee employment or visa
                  approval, as these are subject to the discretion of employers and
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-2">
                  <li>
                    Providing accurate and truthful information in applications
                  </li>
                  <li>Ensuring all uploaded documents are authentic</li>
                  <li>
                    Complying with the laws of the UAE and the destination country
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-10">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                  WorkinEU HR Consultancy LLC shall not be liable for any indirect,
