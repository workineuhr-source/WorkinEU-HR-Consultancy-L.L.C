      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          [1, 2, 3, 4, 5, 6].map((i) => (
            <div
              key={i}
              className="bg-white p-6 rounded-2xl border border-gray-100 animate-pulse h-48"
            ></div>
          ))
        ) : filteredMessages.length === 0 ? (
          <div className="col-span-full text-center py-20 bg-white dark:bg-[#121212] rounded-3xl border border-dashed border-gray-200">
          ...
          filteredMessages.map((msg) => (
            ...
            >
              ...
              <h3 className="font-bold text-brand-blue mb-1 truncate">
                {msg.fullName}
              </h3>
            ...
            >
              <div className="flex justify-between items-start mb-6 md:mb-10">
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div>
                    <h2 className="text-xl md:text-2xl font-bold text-brand-blue">
                      {selectedMessage.fullName}
                    </h2>
                    <p className="text-xs md:text-sm text-gray-500 dark:text-gray-300 flex items-center gap-2">
                      <Calendar size={14} />{" "}
              ...
              <div className="mb-6 md:mb-10">
                ...
                <div className="bg-brand-blue/5 p-6 md:p-8 rounded-3xl relative">
                  <MessageSquare
                    className="absolute -top-4 -left-4 text-brand-gold/20 hidden sm:block"
                    size={48}
                  />
                  <p className="text-sm md:text-base text-gray-700 dark:text-gray-200 leading-relaxed italic whitespace-pre-wrap">
