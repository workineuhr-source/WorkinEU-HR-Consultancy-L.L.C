...
export default function AdminContent() {
  ...
  const seedDefaults = () => {
    setContent({
      ...content,
      heroTitle:
        content.heroTitle || "Your Premier Bridge to Global Career Excellence",
      heroTagline:
        content.heroTagline ||
        "Ethical Recruitment • Global Reach • Professional Success",
      heroDescription:
        content.heroDescription ||
        "Specializing in sourcing and placing skilled talent across Europe and the Middle East. With 600+ successful placements and a presence in multiple continents, we empower your professional journey.",
      ...
      heroImageUrls: content.heroImageUrls?.length
      ...
      ctaDescription:
        ...
        "Join over 600+ successful candidates who have found their dream roles in Europe and the Gulf through our ethical and transparent recruitment process.",
      ...
      countriesDescription:
        content.countriesDescription ||
        "With main operations in Dubai and branches in Nepal, Sri Lanka, India, and Africa, we connect talent to top employers in Latvia, Lithuania, Romania, and the UAE.",
      aboutUs:
        content.aboutUs ||
      ...
      mission:
        content.mission ||
        "To empower organizations by aligning their HR strategy with business objectives, enhancing efficiency and productivity through expert workforce solutions across Europe and the Gulf.",
      vision:
        content.vision ||
      ...
      values: [
        {
          ...
          description:
            "We conduct all activities with honesty and openness, ensuring trust in every interaction.",
        },
        {
          title: "Respect & Fairness",
          description:
            "Fostering relationships built on mutual respect and equal opportunity for all candidates.",
        },
        {
          title: "Accountability",
          description:
            "We take full responsibility for our actions and maintain the highest professional standards.",
        },
        {
          title: "Quality & Ethics",
          description:
            "Adherence to strict compliance and ethical recruitment practices, ensuring total client satisfaction.",
        },
      ],
      services: [
        {
          ...
          description:
            "Sourcing skilled and unskilled workers from Asia, Africa, and the Gulf for European industries.",
          imageUrl:
        ...
        },
        {
          ...
          description:
            "Expert legal documentation, visa processing, and embassy coordination for smooth deployment.",
          imageUrl:
        ...
        },
        {
          ...
          description:
            "Customized recruitment campaigns and high-level executive search for specialized roles.",
          imageUrl:
        ...
        },
        {
          ...
          description:
            "Ongoing performance tracking and support for both employers and candidates post-deployment.",
          imageUrl:
      ...
      branchOffices: [
        {
          ...
          address:
            "Mai Tower, 4th Floor Royal Zone Business Center, Al Nahda 1, Dubai, UAE",
          phone: "+971 55 299 7311",
          email: "info@workineu.co",
        },
        {
          location: "Nepal Office",
          address: "Singamangal-9, Kathmandu, Nepal",
          phone: "+977-01-4560541",
          email: "info@workineu.co",
        },
        {
          location: "Sri Lanka Office",
          address: "No.600/4A, Kandy Road, Eldeniya, Kadawatha, Sri Lanka",
      ...
      livingSectionTitle:
        content.livingSectionTitle || "Life and Integration in Europe",
      globalStandardsTagline:
        content.globalStandardsTagline || "Excellence in HR",
      globalStandardsTitle:
        content.globalStandardsTitle || "Ethical Global Recruitment Standards",
      globalStandardsDescription:
        content.globalStandardsDescription ||
        "WorkinEU is committed to excellence by bridging the gap between world-class talent and global opportunities through integrity and unmatched expertise.",
      livingSection: {
        title: "Work and Life Abroad",
        description:
          "Comprehensive support for transition, including housing coordination and legal integration assistance.",
        features: [
          {
            title: "Housing Coordination",
            description:
              "Ensuring safe and compliant living conditions for candidates.",
          },
          {
            title: "Legal Path",
            description:
              "Full assistance with work permits, city registration, and health insurance.",
          },
          {
            title: "Onboarding",
            description:
              "Professional orientation to help you adapt to your new work environment.",
          },
        ],
      },
      ourProcess: {
        ...
        description:
          "A structured flowchart designed for maximum efficiency and candidate protection.",
        steps: [
          {
            title: "Requirement Analysis",
            description:
              "Deep understanding of client workforce needs and job requisition.",
          },
          {
            title: "Strategic Sourcing",
            description:
              "Accessing our network of 500+ candidates to find the perfect match.",
          },
          {
            title: "Screening & Testing",
            description:
              "Rigorous skill testing and interviews to ensure quality standards.",
          },
          {
            title: "Deployment",
            description:
              "Full logistical support for visa processing and pre-departure orientation.",
          },
        ],
      },
      whyChooseUs: {
        ...
        description:
          "Proven success, global reach, and a commitment to ethical hiring practices.",
        points: [
          {
            title: "600+ Placements",
            description:
              "A track record of success across diversified industries.",
          },
          {
            title: "Global Network",
            description:
              "Presence across multiple continents with certified recruitment partners.",
          },
          {
            title: "Total Compliance",
            description:
              "Full adherence to international labor laws and visa procedures.",
          },
          {
            title: "Client Trust",
            description:
              "Trusted by top employers in the European Union and the Gulf region.",
          },
        ],
      },
      socialLinks: {
      ...
      whyChooseUsImageUrl:
        "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&q=80&w=800",
      guidingPrinciplesImageUrl:
        "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=800",
      faqs: [
        {
          question: "How long does the visa processing take?",
          answer:
            "The duration varies by country and job category, typically ranging from 3 to 6 months for most European roles.",
        },
        {
          question: "What documents are required for registration?",
          answer:
            "You will need a valid passport, updated CV (Europass format preferred), education certificates, and experience letters.",
        },
        {
          question: "Do you provide guidance for the VFS appointment?",
          answer:
            "Yes, we provide full support for VFS appointments, document legalization, and pre-interview preparation.",
        },
        {
          question: "Are there any upfront fees for processing?",
          answer:
            "WorkinEU follows ethical recruitment practices. Any mandatory service fees are transparently communicated and agreed upon before processing.",
        },
      ],
      partners: [
        {
        ...
        {
          name: "EU Logistics SIA",
          logoUrl:
            "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?auto=format&fit=crop&q=80&w=200",
        },
        {
          name: "Global Maritime",
          logoUrl:
            "https://images.unsplash.com/photo-1559136555-9303baea8ebd?auto=format&fit=crop&q=80&w=200",
        },
      ],
      professionalHrSolutionsTitle: "Precision-Guided HR Solutions",
      professionalHrSolutionsDescription:
        "We provide end-to-end recruitment services tailored to the unique regulatory environments of Latvia, Lithuania, Romania, and the UAE. From talent discovery to full logistical deployment, we handle every detail with professional precision.",
      assistants: [
        {
          id: "raj-consultant",
          name: "Raj",
          ...
          photoUrl: "/raj.jpg",
          systemPrompt:
            "You are Raj, a senior consultant at WorkinEU. You are an expert in European recruitment (Latvia, Romania, Poland) and Middle East staffing.",
          isActive: true,
          color: "#0F172A",
        },
      ],
    ...
    toast.success(
      "Professional company data loaded! Please Review and Save changes.",
    );
  };
  ...
  const handleProcessStepChange = (
    ...
    setContent({
      ...content,
      ourProcess: { ...content.ourProcess!, steps: newSteps },
    });
  };
  ...
  const addStat = () => {
    setContent({
      ...content,
      stats: [...(content.stats || []), { label: "", value: "" }],
    });
  };
  ...
  const handleLivingFeatureChange = (
    index: number,
    field: "title" | "description",
    value: string,
  ) => {
    ...
    setContent({
      ...content,
      livingSection: { ...content.livingSection!, features: newFeatures },
    });
  };
  ...
  const removeLivingFeature = (index: number) => {
    setContent({
      ...
      livingSection: {
        ...content.livingSection!,
        features: (content.livingSection?.features || []).filter(
          (_, i) => i !== index,
        ),
      },
    });
  ...
  const removeBranch = (index: number) => {
    setContent({
      ...content,
      branchOffices: (content.branchOffices || []).filter(
        (_, i) => i !== index,
      ),
    });
  };
  ...
  const removeStrength = (index: number) => {
    setContent({
      ...content,
      coreStrengths: (content.coreStrengths || []).filter(
        (_, i) => i !== index,
      ),
    });
  };

  const handleWhyPointChange = (
    index: number,
    field: "title" | "description",
    value: string,
  ) => {
  ...
  const removeWhyPoint = (index: number) => {
    setContent({
      ...
      whyChooseUs: {
        ...(content.whyChooseUs || { title: "", description: "", points: [] }),
        points: (content.whyChooseUs?.points || []).filter(
          (_, i) => i !== index,
        ),
      },
    });
  ...
  const handleListChange = (
    field: "countries" | "jobPositions" | "jobCategories",
    index: number,
    value: string,
  ) => {
  ...
  return (
    <div className="space-y-8 w-full">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-white dark:bg-[#121212] p-8 rounded-3xl shadow-sm border border-gray-100">
        <div>
          <h1 className="text-3xl font-bold text-brand-blue">
            Content Management
          </h1>
          <p className="text-gray-500 dark:text-gray-300">
            Customize every aspect of your website's information and appearance.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
          <button
            onClick={() => setShowSeedConfirm(true)}
            className="flex-1 sm:flex-none bg-gray-50 dark:bg-white/5 text-gray-600 dark:text-gray-300 px-6 py-3.5 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-gray-100 transition-all border border-gray-100"
          >
      ...
      {showSeedConfirm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-brand-blue/60 backdrop-blur-sm">
          ...
          >
            ...
            <p className="text-gray-500 dark:text-gray-300 text-center mb-10 leading-relaxed">
              This will add default lists, services, and sections. Existing data
              will be preserved, but new defaults will be added. This action
              cannot be easily undone.
            </p>
            <div className="flex gap-4">
              <button
                onClick={() => setShowSeedConfirm(false)}
                className="flex-1 px-6 py-4 rounded-2xl font-bold text-gray-500 dark:text-gray-300 hover:bg-gray-50 transition-all"
              >
                Cancel
              </button>
              <button
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-72 shrink-0">
          <div className="sticky top-8 space-y-2 bg-white dark:bg-[#121212] p-4 rounded-3xl shadow-sm border border-gray-100">
            {[
              {
                id: "general",
                label: "1. General & Navbar",
                icon: <Globe size={18} />,
              },
              {
                id: "hero",
                label: "2. Hero Section",
                icon: <ImageIcon size={18} />,
              },
              {
                id: "data",
                label: "3. Lists, Jobs & FAQs",
                icon: <Database size={18} />,
              },
              {
                id: "services",
                label: "4. Professional Services",
                icon: <Briefcase size={18} />,
              },
              {
                id: "impact",
                label: "5. Impact & Statistics",
                icon: <TrendingUp size={18} />,
              },
              {
                id: "expertise",
                label: "6. Expertise & Advantage",
                icon: <ShieldCheck size={18} />,
              },
              {
                id: "living",
                label: "7. Living & Culture",
                icon: <Home size={18} />,
              },
              {
                id: "about",
                label: "8. Our Story & Legacy",
                icon: <Info size={18} />,
              },
              {
                id: "partners",
                label: "9. Industry Leaders",
                icon: <Users2 size={18} />,
              },
              {
                id: "contact",
                label: "10. Contact & Offices",
                icon: <Phone size={18} />,
              },
              {
                id: "visibility",
                label: "11. Commander View",
                icon: <LayoutGrid size={18} />,
              },
              {
                id: "styles",
                label: "12. Visual Styles",
                icon: <Zap size={18} />,
              },
              {
                id: "assistants",
                label: "13. AI Support Bot",
                icon: <Bot size={18} />,
              },
            ].map((tab) => (
              <button
                ...
                className={cn(
                  ...
                  activeTab === tab.id
                    ...
                    : "text-gray-500 dark:text-gray-300 hover:text-brand-blue hover:bg-gray-50 dark:bg-white/5",
                )}
              >
                {tab.icon}
                {tab.label}
          ...
          <div className="grid grid-cols-1 gap-8">
              ...
              >
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <ImageIcon className="text-brand-gold w-6 h-6" /> Branding
                    Assets
                  </h3>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col gap-4">
                        <div className="flex gap-2">
                          <input
                            className="flex-grow px-4 py-3 rounded-xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm"
                        ...
                        <div className="flex gap-2">
                          ...
                          <label className="bg-brand-blue/5 p-3 rounded-xl cursor-pointer hover:bg-brand-blue/10 transition-all flex items-center justify-center text-brand-blue">
                            ...
                            <input
                              ...
                              accept=".pdf"
                              onChange={(e) =>
                                handleFileUpload(e, "companyProfileUrl")
                              }
                            />
                          </label>
                        </div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <label className="bg-brand-blue/5 p-3 rounded-xl cursor-pointer hover:bg-brand-blue/10 transition-all flex items-center justify-center text-brand-blue">
                            ...
                            <input
                              ...
                              accept="image/*"
                              onChange={(e) =>
                                handleFileUpload(e, "footerLogoUrl")
                              }
                            />
                          </label>
                        </div>
                        {content.footerLogoUrl &&
                          content.footerLogoUrl !== "" && (
                            <div className="p-6 bg-gray-50 dark:bg-white/5 rounded-2xl flex items-center justify-center border border-dashed border-gray-200">
                              <img
                                referrerPolicy="no-referrer"
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <Globe className="text-brand-gold w-6 h-6" /> Social Media
                    Presence
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div>
                      ...
                      <input
                        className="w-full px-4 py-3 rounded-xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm font-bold text-brand-blue"
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <Globe className="text-brand-gold w-6 h-6" /> Navigation
                    Labels
                  </h3>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-6">
                      <div>
                        ...
                        />
                        <CharacterCounter
                          current={content.heroTagline.length}
                          max={50}
                        />
                      </div>
                      ...
                      <div className="bg-brand-blue/5 p-6 rounded-2xl border border-brand-blue/10">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <button
                            onClick={() =>
                              setContent({
                                ...content,
                                autoHeroJobs: !content.autoHeroJobs,
                              })
                            }
                            className={cn(
                              "px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all",
                              content.autoHeroJobs
                        ...
                        <p className="text-[10px] text-gray-500 dark:text-gray-300 leading-relaxed">
                          Automatically showcase the latest job title in the
                          Hero headline.
                          <span className="font-bold text-brand-blue ml-1">
                            "Connecting Talent Globally"
                          </span>{" "}
                          will always remain as the top tagline.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        />
                        <CharacterCounter
                          current={(content.heroTitle || "").length}
                          max={60}
                        />
                      </div>
                      <div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {(content.heroImageUrls || []).map((url, i) => (
                          <div
                            key={i}
                            className="p-4 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 relative group pl-10"
                          >
                            <ReorderButtons
                              onMoveUp={() =>
                                moveItem("heroImageUrls", i, "up")
                              }
                              onMoveDown={() =>
                                moveItem("heroImageUrls", i, "down")
                              }
                              isFirst={i === 0}
                              isLast={
                                i === (content.heroImageUrls?.length || 0) - 1
                              }
                            />
                            <button
                              onClick={() =>
                                setContent({
                                  ...content,
                                  heroImageUrls: content.heroImageUrls!.filter(
                                    (_, idx) => idx !== i,
                                  ),
                                })
                              }
                              className="absolute -top-2 -right-2 w-8 h-8 bg-white dark:bg-[#121212] text-red-400 rounded-full shadow-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all hover:bg-red-50 hover:text-red-600 z-10"
                            >
                              <Trash2 size={16} />
                            </button>
                            <div className="space-y-3">
                              <div className="flex gap-2">
                                <input
                                  className="flex-grow px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-brand-gold transition-all text-[10px] bg-white dark:bg-[#121212]"
                                  value={url || ""}
                                  onChange={(e) => {
                                    const newUrls = [
                                      ...(content.heroImageUrls || []),
            ...
            {activeTab === "about" && (
              ...
              >
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <Info className="text-brand-gold w-6 h-6" /> Our Company
                    Story
                  </h3>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setContent({
                                ...content,
                                companyStoryTagline: e.target.value,
                              })
                            }
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setContent({
                                ...content,
                                companyStoryTitle: e.target.value,
                              })
                            }
                      ...
                      <div>
                        ...
                        <textarea
                          rows={10}
                          className="w-full px-4 py-3 rounded-xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm leading-relaxed"
                    ...
                    <div className="space-y-6">
                      <div className="space-y-4">
                        <label className="block text-xs font-bold text-gray-500 dark:text-gray-300 uppercase tracking-widest mb-2">
                          Story Showcase Image (Office Photo)
                        </label>
                        <div className="flex gap-2">
                          <input
                            className="flex-grow px-4 py-3 rounded-xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm"
                        ...
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-xs text-slate-400">
                              Manage members, portraits and roles.
                            </p>
                          </div>
                          <Link
                            to="/admin/team"
                            className="bg-brand-gold text-slate-900 dark:text-white px-6 py-2 rounded-xl font-bold text-xs hover:bg-white transition-all shadow-lg"
                          >
                            Manage Team
                          </Link>
                        </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <Target className="text-brand-gold w-6 h-6" /> Mission &
                    Vision
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      <label className="block text-xs font-bold text-gray-500 dark:text-gray-300 uppercase tracking-widest mb-4">
                        Our Mission
                      </label>
                      <textarea
                        rows={6}
                        className="w-full px-6 py-4 rounded-3xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm leading-relaxed italic"
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="space-y-4">
                        {(content.values || []).map((value, index) => (
                          <div
                            key={index}
                            className="p-6 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 relative group pl-12"
                          >
                            <ReorderButtons
                              onMoveUp={() => moveItem("values", index, "up")}
                              onMoveDown={() =>
                                moveItem("values", index, "down")
                              }
                              isFirst={index === 0}
                              isLast={
                                index === (content.values || []).length - 1
                              }
                            />
                            <button
                              onClick={() => removeValue(index)}
                              className="absolute -top-2 -right-2 w-8 h-8 bg-white dark:bg-[#121212] text-red-500 rounded-full shadow-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all hover:bg-red-50 z-10"
                            >
                              <Trash2 size={16} />
                            </button>
                            <div className="grid grid-cols-1 gap-3">
                              <input
                                className="w-full px-4 py-2 rounded-xl border border-gray-200 outline-none focus:border-brand-gold transition-all text-sm font-bold bg-white dark:bg-[#121212]"
                                value={value.title}
                                onChange={(e) =>
                                  handleValueChange(
                                    index,
                              ...
                              <textarea
                                rows={2}
                                className="w-full px-4 py-2 rounded-xl border border-gray-200 outline-none focus:border-brand-gold transition-all text-xs bg-white dark:bg-[#121212] text-gray-500 dark:text-gray-300 leading-relaxed font-medium"
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              guidingPrinciplesImageUrl: e.target.value,
                            })
                          }
                          placeholder="Image URL"
                        />
                        <label className="bg-brand-blue text-white p-3 rounded-xl cursor-pointer hover:bg-brand-gold hover:text-brand-blue transition-all flex items-center justify-center">
                          {uploading === "guidingPrinciplesImageUrl" ? (
                            <Loader2 className="animate-spin" size={20} />
                          ) : (
                            <Upload size={20} />
                          )}
                          <input
                            ...
                            accept="image/*"
                            onChange={(e) =>
                              handleFileUpload(e, "guidingPrinciplesImageUrl")
                            }
                          />
                        </label>
                      </div>
            ...
            {activeTab === "expertise" && (
              ...
              >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setContent({
                                ...content,
                                professionalHrSolutionsBadge: e.target.value,
                              })
                            }
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setContent({
                                ...content,
                                professionalHrSolutionsTitle: e.target.value,
                              })
                            }
                      ...
                      <div>
                        ...
                        <textarea
                          rows={8}
                          className="w-full px-4 py-3 rounded-xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm leading-relaxed font-medium"
                          value={
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              professionalHrSolutionsImageUrl: e.target.value,
                            })
                          }
                          placeholder="Image URL"
                        />
                        <label className="bg-brand-blue/5 p-3 rounded-xl cursor-pointer hover:bg-brand-blue/10 transition-all flex items-center justify-center text-brand-blue">
                          {uploading === "professionalHrSolutionsImageUrl" ? (
                            <Loader2 className="animate-spin" size={20} />
                          ) : (
                            <Upload size={20} />
                          )}
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                      <h3 className="text-xl font-bold text-brand-blue mb-4 flex items-center gap-3">
                        <ShieldCheck className="text-brand-gold w-6 h-6" /> Core
                        Strengths
                      </h3>
                      <label className="block text-xs font-bold text-gray-500 dark:text-gray-300 uppercase tracking-widest mb-2">
                      ...
                      <input
                        className="w-full px-4 py-3 rounded-xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm font-bold mb-6"
                        value={content.coreStrengthsTitle || ""}
                        onChange={(e) =>
                          setContent({
                            ...content,
                            coreStrengthsTitle: e.target.value,
                          })
                        }
                      ...
                      <div className="space-y-3">
                        {(content.coreStrengths || []).map(
                          (strength, index) => (
                            <div key={index} className="flex gap-2 group">
                              <input
                                className="flex-1 px-4 py-2 rounded-lg border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm font-medium"
                                value={strength}
                                onChange={(e) =>
                              ...
                              <button
                                ...
                                className="p-2 text-gray-300 hover:text-red-500 transition-colors bg-gray-100 rounded-lg"
                              >
                                <Trash2 size={16} />
                              </button>
                            </div>
                      ...
                      <div className="p-6 bg-brand-blue/5 rounded-2xl border border-brand-blue/10 mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          <div>
                            ...
                            <input
                              className="w-full px-4 py-2 rounded-lg border border-gray-100 bg-white dark:bg-[#121212] outline-none focus:border-brand-gold font-bold text-xs"
                              value={content.professionalEdgeTitle || ""}
                              onChange={(e) =>
                                setContent({
                                  ...content,
                                  professionalEdgeTitle: e.target.value,
                                })
                              }
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setContent({
                                  ...content,
                                  professionalEdgeSubtitle: e.target.value,
                                })
                              }
                        ...
                        <div>
                          ...
                          <textarea
                            rows={4}
                            className="w-full px-4 py-2 rounded-lg border border-gray-100 bg-white dark:bg-[#121212] outline-none focus:border-brand-gold text-xs leading-relaxed"
                            value={content.professionalEdgeDescription || ""}
                            onChange={(e) =>
                              setContent({
                                ...content,
                                professionalEdgeDescription: e.target.value,
                              })
                            }
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              coreStrengthsImageUrl: e.target.value,
                            })
                          }
                          placeholder="Image URL"
                        />
                        <label className="bg-brand-blue/5 p-3 rounded-xl cursor-pointer hover:bg-brand-blue/10 transition-all flex items-center justify-center text-brand-blue">
                          {uploading === "coreStrengthsImageUrl" ? (
                            <Loader2 className="animate-spin" size={20} />
                          ) : (
                            <Upload size={20} />
                          )}
                          <input
                            ...
                            accept="image/*"
                            onChange={(e) =>
                              handleFileUpload(e, "coreStrengthsImageUrl")
                            }
                          />
                        </label>
                      </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <SectionHeader
                    ...
                    onToggle={() =>
                      setContent({
                        ...content,
                        showWhyChooseUs: !content.showWhyChooseUs,
                      })
                    }
                  ...
                  <div className="space-y-6 mb-8">
                    ...
                    <div className="mt-6">
                      <label className="block text-xs font-bold text-gray-500 dark:text-gray-300 uppercase tracking-widest mb-2">
                        Advantage Section Heading Image (Side Photo)
                      </label>
                      <div className="flex gap-2">
                        <input
                          className="flex-grow px-4 py-3 rounded-xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm"
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              whyChooseUsImageUrl: e.target.value,
                            })
                          }
                          placeholder="Image URL"
                        />
                        <label className="bg-brand-blue/5 p-3 rounded-xl cursor-pointer hover:bg-brand-blue/10 transition-all flex items-center justify-center text-brand-blue">
                          {uploading === "whyChooseUsImageUrl" ? (
                            <Loader2 className="animate-spin" size={20} />
                          ) : (
                            <Upload size={20} />
                          )}
                          <input
                            ...
                            accept="image/*"
                            onChange={(e) =>
                              handleFileUpload(e, "whyChooseUsImageUrl")
                            }
                          />
                        </label>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {(content.whyChooseUs?.points || []).map((point, i) => (
                      <div
                        key={i}
                        className="p-6 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 relative group pl-10"
                      >
                        <ReorderButtons
                          onMoveUp={() =>
                            moveNestedItem("whyChooseUs", "points", i, "up")
                          }
                          onMoveDown={() =>
                            moveNestedItem("whyChooseUs", "points", i, "down")
                          }
                          isFirst={i === 0}
                          isLast={
                            i === (content.whyChooseUs?.points || []).length - 1
                          }
                        />
                        <button
                        ...
                        <div className="space-y-4">
                          <input
                            className="w-full px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-brand-gold transition-all text-sm font-bold bg-white dark:bg-[#121212]"
                            value={point.title}
                            onChange={(e) =>
                              handleWhyPointChange(i, "title", e.target.value)
                            }
                            placeholder="Advantage Title"
                          />
                          <textarea
                            rows={3}
                            className="w-full px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-brand-gold transition-all text-xs bg-white dark:bg-[#121212] text-gray-500 dark:text-gray-300"
                            value={point.description}
                            onChange={(e) =>
                              handleWhyPointChange(
                                i,
                                "description",
                                e.target.value,
                              )
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <Target className="text-brand-gold w-6 h-6" /> Conversion
                    Point (Bottom CTA)
                  </h3>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-6">
            ...
            {activeTab === "impact" && (
              ...
              >
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <Globe className="text-brand-gold w-6 h-6" /> Commitment &
                    Global Standards
                  </h3>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setContent({
                                ...content,
                                globalStandardsTagline: e.target.value,
                              })
                            }
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setContent({
                                ...content,
                                globalStandardsTitle: e.target.value,
                              })
                            }
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              globalStandardsDescription: e.target.value,
                            })
                          }
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              globalStandardsImageUrl: e.target.value,
                            })
                          }
                          placeholder="Image URL"
                        />
                        <label className="bg-brand-blue/5 p-3 rounded-xl cursor-pointer hover:bg-brand-blue/10 transition-all flex items-center justify-center text-brand-blue">
                          {uploading === "globalStandardsImageUrl" ? (
                            <Loader2 className="animate-spin" size={20} />
                          ) : (
                            <Upload size={20} />
                          )}
                          <input
                            ...
                            accept="image/*"
                            onChange={(e) =>
                              handleFileUpload(e, "globalStandardsImageUrl")
                            }
                          />
                        </label>
                      </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <SectionHeader
                    ...
                    onToggle={() =>
                      setContent({ ...content, showStats: !content.showStats })
                    }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                    {content.stats?.map((stat, i) => (
                      <div
                        key={i}
                        className="group bg-gray-50 dark:bg-white/5 p-6 rounded-2xl border border-gray-100 relative pl-10"
                      >
                        <ReorderButtons
                        ...
                        <div className="space-y-4">
                          <input
                            ...
                            className="w-full px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-brand-gold bg-white dark:bg-[#121212] font-bold text-lg text-brand-blue"
                            value={stat.value}
                            onChange={(e) => {
                              const newStats = [...content.stats!];
                          ...
                          <input
                            placeholder="Label"
                            className="w-full px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-brand-gold bg-white dark:bg-[#121212] text-xs font-semibold text-gray-500 dark:text-gray-300"
                            value={stat.label}
                            onChange={(e) => {
                              const newStats = [...content.stats!];
                  ...
                  <div className="mb-12 p-8 bg-brand-blue/5 rounded-[2.5rem] border border-brand-blue/10">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                      <div>
                        ...
                        <input
                          className="w-full px-4 py-3 rounded-xl border border-gray-100 bg-white dark:bg-[#121212] outline-none focus:border-brand-gold transition-all text-sm font-bold"
                      ...
                      <div>
                        ...
                        <textarea
                          rows={1}
                          className="w-full px-4 py-3 rounded-xl border border-gray-100 bg-white dark:bg-[#121212] outline-none focus:border-brand-gold transition-all text-sm"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                      <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-300 mb-4">
                          This image will appear next to the Professional HR
                          Solutions title on the homepage.
                        </p>
                        <div className="flex gap-2">
                          <input
                            className="flex-grow px-4 py-3 rounded-xl border border-gray-100 bg-white dark:bg-[#121212] outline-none focus:border-brand-gold transition-all text-sm"
                            value={content.servicesImageUrl || ""}
                            onChange={(e) =>
                              setContent({
                                ...content,
                                servicesImageUrl: e.target.value,
                              })
                            }
                            placeholder="Image URL"
                          />
                          <label className="bg-brand-blue text-white p-3 rounded-xl cursor-pointer hover:bg-brand-gold hover:text-brand-blue transition-all flex items-center justify-center">
                            {uploading === "servicesImageUrl" ? (
                              <Loader2 className="animate-spin" size={20} />
                            ) : (
                              <Upload size={20} />
                            )}
                            <input
                              ...
                              accept="image/*"
                              onChange={(e) =>
                                handleFileUpload(e, "servicesImageUrl")
                              }
                            />
                          </label>
                        </div>
                    ...
                    {content.services.map((service, i) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="absolute -top-2 -right-2 w-8 h-8 bg-white dark:bg-[#121212] text-red-400 rounded-full shadow-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all hover:bg-red-50 hover:text-red-600"
                        >
                          <Trash2 size={16} />
                        </button>
                        <div className="space-y-4">
                          ...
                          <div className="flex gap-2">
                            ...
                            />
                            {service.imageUrl && (
                              <CopyButton text={service.imageUrl} />
                            )}
                            <label className="bg-brand-blue/5 p-2 rounded-lg cursor-pointer hover:bg-brand-blue/10 transition-all flex items-center justify-center text-brand-blue">
                              {uploading === `service_${i}` ? (
                              ...
                              <input
                                ...
                                accept="image/*"
                                onChange={(e) =>
                                  handleFileUpload(e, `service_${i}`, i)
                                }
                              />
                            </label>
                          </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <SectionHeader
                    ...
                    onToggle={() =>
                      setContent({
                        ...content,
                        showProcess: !content.showProcess,
                      })
                    }
                  ...
                  <div className="space-y-6 mb-8">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setContent({
                            ...content,
                            ourProcessTitle: e.target.value,
                          })
                        }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        />
                        <CharacterCounter
                          current={(content.ourProcess?.title || "").length}
                          max={50}
                        />
                      </div>
                      <div>
                        ...
                        <CharacterCounter
                          current={
                            (content.ourProcess?.description || "").length
                          }
                          max={150}
                        />
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {(content.ourProcess?.steps || []).map((step, i) => (
                      ...
                      >
                        <ReorderButtons
                          onMoveUp={() =>
                            moveNestedItem("ourProcess", "steps", i, "up")
                          }
                          onMoveDown={() =>
                            moveNestedItem("ourProcess", "steps", i, "down")
                          }
                          isFirst={i === 0}
                          isLast={
                            i === (content.ourProcess?.steps || []).length - 1
                          }
                        />
            ...
            {activeTab === "contact" && (
              ...
              >
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <Phone className="text-brand-gold w-6 h-6" /> Contact
                    Information
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                    ...
                    <div>
                      <label className="block text-xs font-bold text-gray-500 dark:text-gray-300 uppercase tracking-widest mb-2">
                        Google Maps URL (Visit Our Office)
                      </label>
                      <input
                        className="w-full px-4 py-3 rounded-xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm"
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <div className="flex justify-between items-center mb-8">
                    <h3 className="text-xl font-bold text-brand-blue flex items-center gap-3">
                      <MapPin className="text-brand-gold w-6 h-6" /> Branch
                      Offices
                    </h3>
                    <button
                      onClick={() =>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {(content.branchOffices || []).map((branch, i) => (
                      <div
                        key={i}
                        className="p-6 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 relative group"
                      >
                        <button
                          onClick={() =>
                            setContent({
                        ...
                        <div className="space-y-4">
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              setContent({
                                ...content,
                                branchOffices: newBranches,
                              });
                            }}
                          />
                          <input
                            placeholder="Address"
                            className="w-full px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-brand-gold transition-all text-xs bg-white dark:bg-[#121212]"
              ...
              >
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <SectionHeader
                    ...
                    onToggle={() =>
                      setContent({ ...content, showFaqs: !content.showFaqs })
                    }
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          <div>
                            ...
                            <input
                              className="w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-brand-gold transition-all text-sm font-bold bg-white dark:bg-[#121212]"
                              value={faq.question}
                              onChange={(e) =>
                          ...
                          <div>
                            ...
                            <textarea
                              rows={2}
                              className="w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-brand-gold transition-all text-sm bg-white dark:bg-[#121212]"
                              value={faq.answer}
                              onChange={(e) =>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-12">
                  <div>
                    <h4 className="text-md font-bold text-brand-blue mb-6 flex items-center gap-3">
                      <Briefcase className="text-brand-gold w-5 h-5" /> Featured
                      Jobs Header
                    </h4>
                  ...
                  <div className="pt-8 border-t border-gray-100">
                    <h4 className="text-md font-bold text-brand-blue mb-6 flex items-center gap-3">
                      <Target className="w-5 h-5 text-gradient" /> Visa Success
                      Gallery Header
                    </h4>
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              successStoriesTagline: e.target.value,
                            })
                          }
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              successStoriesTitle: e.target.value,
                            })
                          }
                        />
                      </div>
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              successStoriesSubtitle: e.target.value,
                            })
                          }
                        />
                      </div>
                  ...
                  <div className="pt-8 border-t border-gray-100">
                    <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                      <Globe className="text-brand-gold w-6 h-6" /> Countries
                      Section Header
                    </h3>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              countriesTagline: e.target.value,
                            })
                          }
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            setContent({
                              ...content,
                              countriesDescription: e.target.value,
                            })
                          }
                        />
                      </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                    <div className="flex justify-between items-center mb-6">
                      ...
                      <button
                        onClick={() => addListItem("countries")}
                        className="text-brand-gold hover:text-brand-blue"
                      >
                        <Plus size={20} />
                      </button>
                    </div>
                    <div className="space-y-2 max-h-[400px] overflow-y-auto pr-2">
                      {(content.countries || []).map((country, i) => (
                        <div key={i} className="flex gap-2 group">
                          <input
                            className="flex-1 px-4 py-2 rounded-lg border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm"
                            value={country}
                            onChange={(e) =>
                              handleListChange("countries", i, e.target.value)
                            }
                          />
                          <button
                            onClick={() => removeListItem("countries", i)}
                  ...
                  <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                    <div className="flex justify-between items-center mb-6">
                      ...
                      <button
                        onClick={() => addListItem("jobPositions")}
                        className="text-brand-gold hover:text-brand-blue"
                      >
                        <Plus size={20} />
                      </button>
                    ...
                    <div className="space-y-2 max-h-[400px] overflow-y-auto pr-2">
                      {(content.jobPositions || []).map((pos, i) => (
                        <div key={i} className="flex gap-2 group">
                          ...
                          />
                          <button
                            onClick={() => removeListItem("jobPositions", i)}
                            className="text-gray-300 hover:text-red-500 transition-colors opacity-0 group-hover:opacity-100"
                          >
                            <Trash2 size={16} />
                          </button>
                  ...
                  <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                    <div className="flex justify-between items-center mb-6">
                      ...
                      <button
                        onClick={() => addListItem("jobCategories")}
                        className="text-brand-gold hover:text-brand-blue"
                      >
                        <Plus size={20} />
                      </button>
                    ...
                    <div className="space-y-2 max-h-[400px] overflow-y-auto pr-2">
                      {(content.jobCategories || []).map((cat, i) => (
                        <div key={i} className="flex gap-2 group">
                          ...
                          />
                          <button
                            onClick={() => removeListItem("jobCategories", i)}
                            className="text-gray-300 hover:text-red-500 transition-colors opacity-0 group-hover:opacity-100"
                          >
                            <Trash2 size={16} />
                          </button>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <SectionHeader
                    ...
                    onToggle={() =>
                      setContent({
                        ...content,
                        showPartners: !content.showPartners,
                      })
                    }
                      ...
                      >
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <input
                              className="w-full px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-brand-gold bg-white dark:bg-[#121212] font-bold text-brand-blue"
                              value={partner.name}
                              onChange={(e) => {
                          ...
                          <div>
                            ...
                            <div className="flex gap-2">
                              <input
                                className="flex-grow px-4 py-2 rounded-lg border border-gray-200 outline-none focus:border-brand-gold bg-white dark:bg-[#121212] text-sm"
            ...
            {activeTab === "living" && (
              ...
              >
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <Home className="text-brand-gold w-6 h-6" /> Living &
                    Accommodation Section
                  </h3>
                  <div className="grid grid-cols-1 gap-8">
                    <div className="space-y-4">
                      <label className="block text-xs font-bold text-gray-500 dark:text-gray-300 uppercase tracking-widest mb-2">
                        Living Section Title (HomePage Main Heading)
                      </label>
                      <input
                        className="w-full px-4 py-3 rounded-xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all text-sm font-bold"
                        ...
                        onChange={(e) =>
                          setContent({
                            ...content,
                            livingSectionTitle: e.target.value,
                          })
                        }
                    ...
                    <div className="space-y-4">
                      ...
                      <textarea
                        rows={4}
                        className="w-full px-4 py-3 rounded-xl border border-gray-100 bg-gray-50 dark:bg-white/5 outline-none focus:bg-white focus:border-brand-gold transition-all"
                      ...
                      <div className="flex flex-col gap-4">
                        <div className="flex gap-2">
                          <input
                            ...
                            placeholder="Image URL"
                          />
                          {content.livingSection?.imageUrl && (
                            <CopyButton text={content.livingSection.imageUrl} />
                          )}
                          <label className="bg-brand-blue/5 p-3 rounded-xl cursor-pointer hover:bg-brand-blue/10 transition-all flex items-center justify-center text-brand-blue">
                            {uploading === "livingSection_image" ? (
                              <Loader2 className="animate-spin" size={20} />
                            ) : (
                              <Upload size={20} />
                            )}
                            <input
                              ...
                              accept="image/*"
                              onChange={(e) =>
                                handleFileUpload(e, "livingSection_image")
                              }
                            />
                          </label>
                        </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  ...
                  />
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {(content.livingSection?.features || []).map(
                      (feature, i) => (
                        <div
                          key={i}
                          className="p-6 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100 relative group pl-10"
                        >
                          <ReorderButtons
                            ...
                            isLast={
                              i ===
                              (content.livingSection?.features || []).length - 1
                            }
                          />
                          <button
                          ...
                          <div className="space-y-4">
                            <input
                              className="w-full px-4 py-2 rounded-lg border border-gray-100 bg-white dark:bg-[#121212] outline-none focus:border-brand-gold transition-all font-bold text-brand-blue"
                              value={feature.title}
                              onChange={(e) =>
                                handleLivingFeatureChange(
                                  i,
                                  "title",
                                  e.target.value,
                                )
                            ...
                            <textarea
                              rows={3}
                              className="w-full px-4 py-2 rounded-lg border border-gray-100 bg-white dark:bg-[#121212] outline-none focus:border-brand-gold transition-all text-sm text-gray-500 dark:text-gray-300"
            ...
            {activeTab === "visibility" && (
              ...
              >
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <LayoutGrid className="text-brand-gold w-6 h-6" /> Home Page
                    Layout Manager
                  </h3>
                  <p className="text-gray-500 dark:text-gray-300 mb-8">
                    Drag and drop sections to reorder them, or use the toggles
                    to hide/show sections on the homepage.
                  </p>
                    ...
                    {[
                      {
                        ...
                        description: "Displays your agency impact numbers.",
                      },
                      {
                        id: "showServices",
                        label: "Our Services",
                        description:
                          "Showcases the professional services you offer.",
                      },
                      {
                        id: "showWhyChooseUs",
                        label: "Why Choose Us",
                        description: "Highlights your unique selling points.",
                      },
                      {
                        id: "showCountries",
                        label: "Countries We Serve",
                        description:
                          "Lists the countries where you have job openings.",
                      },
                      {
                        id: "showProcess",
                        label: "Our Process",
                        description: "Explains the recruitment journey steps.",
                      },
                      {
                        id: "showFaqs",
                        label: "FAQs",
                        description: "Answers common questions from users.",
                      },
                      {
                        id: "showPartners",
                        label: "Our Partners/Clients",
                        description: "Displays logos of industry partners.",
                      },
                      {
                        id: "showSuccessStories",
                        label: "Visa Success Stories",
                        description:
                          "Shows real-life candidate success stories.",
                      },
                      {
                        id: "showDiary",
                        label: "Latest from Diary",
                        description: "Displays recent blog posts or news.",
                      },
                      {
                        id: "showLivingSection",
                        label: "Living & Accommodation",
                        description: "Details about housing and support.",
                      },
                    ].map((section) => (
                      <div
                        key={section.id}
                        className={cn(
                          ...
                          (content as any)[section.id]
                            ? "bg-white border-brand-gold/20 shadow-md"
                      ...
                      >
                        ...
                        <button
                          onClick={() =>
                            setContent({
                              ...content,
                              [section.id]: !(content as any)[section.id],
                            })
                          }
                          className={cn(
                        ...
                        >
                          <div
                            className={cn(
                              "absolute top-1 w-5 h-5 bg-white dark:bg-[#121212] rounded-full transition-all shadow-sm",
                              (content as any)[section.id]
                                ? "right-1"
                                : "left-1",
                            )}
            ...
            {activeTab === "styles" && (
              ...
              >
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <h3 className="text-xl font-bold text-brand-blue mb-8 flex items-center gap-3">
                    <Zap className="text-brand-gold w-6 h-6" /> Typography &
                    Color Identities
                  </h3>
                  <p className="text-gray-500 dark:text-gray-300 mb-8 max-w-2xl">
                    Customize the emotional tone of your website by choosing
                    premium font pairings and colors for key hero elements.
                  </p>
                  ...
                  <div className="grid grid-cols-1 gap-12">
                    {[
                      ...
                      <div
                        key={section.key}
                        className="p-8 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] border border-gray-100"
                      >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                              ...
                              {FONT_OPTIONS.map((f) => (
                                <button
                                  ...
                                  onClick={() => {
                                    ...
                                    if (
                                      !newStyles[
                                        section.key as keyof typeof newStyles
                                      ]
                                    )
                                      (newStyles as any)[section.key] = {};
                                  ...
                                  className={cn(
                                    ...
                                    (content.styles as any)?.[section.key]
                                      ?.font === f.id
                                      ? "bg-brand-blue text-white ring-4 ring-brand-blue/5 border-transparent"
                                      : "bg-white text-slate-600 dark:text-slate-300 border-slate-100 hover:border-brand-teal",
                                  )}
                                >
                                  <span
                                    className={cn(
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      ...
                                      if (
                                        ...
                                        (newStyles as any)[section.key] = {};
                                      (newStyles as any)[section.key].color =
                                        c.id;
                                      setContent({
                                        ...content,
                                        styles: newStyles,
                          ...
                          <div className="space-y-4 lg:col-span-1">
                            ...
                            <div className="p-8 bg-white dark:bg-[#121212] rounded-3xl border border-slate-100 shadow-inner flex items-center justify-center min-h-[160px] text-center">
                              {!section.isButton && !section.isSection && (
                                <p
                                  className={cn(
                                    "text-2xl font-black",
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                  <SectionHeader
                    ...
                    onAdd={() => {
                      const newAsst = {
                        ...
                        photoUrl: "",
                        systemPrompt:
                          "You are a helpful assistant for WorkinEU...",
                        isActive: true,
                        color: "#121212",
                      };
                      setContent({
                        ...content,
                        assistants: [...(content.assistants || []), newAsst],
                      });
                    }}
                  />
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    {!content.assistants || content.assistants.length === 0 ? (
                      <div className="text-center py-20 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] border border-dashed border-gray-200">
                        <Bot size={48} className="mx-auto text-gray-300 mb-4" />
                        <p className="text-gray-500 dark:text-gray-300 font-bold">
                          No assistants configured. Use "Seed Defaults" or "Add
                          New" to get started.
                        </p>
                      </div>
                    ) : (
                      content.assistants.map((asst, i) => (
                        <div
                          key={asst.id}
                          className="p-8 bg-gray-50 dark:bg-white/5 rounded-[2.5rem] border border-gray-100 relative group"
                        >
                          <div className="absolute top-8 right-8 flex items-center gap-4">
                            ...
                            <button
                              onClick={() =>
                                setContent({
                                  ...content,
                                  assistants: content.assistants!.filter(
                                    (a) => a.id !== asst.id,
                                  ),
                                })
                              }
                              className="w-10 h-10 bg-white dark:bg-[#121212] text-red-400 rounded-xl shadow-sm border border-gray-100 flex items-center justify-center hover:bg-red-50 hover:text-red-600 transition-all"
                            >
                              <Trash2 size={18} />
                            </button>
                          </div>
                                ...
                                {[
                                  ...
                                  <button
                                    ...
                                    className={cn(
                                      ...
                                      asst.color === c
                                        ? "border-brand-gold scale-125 shadow-lg"
                                        : "border-transparent",
                                    )}
                            ...
                            <div className="lg:col-span-10 space-y-6">
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                  ...
                                  <input
                                    className="w-full px-6 py-4 rounded-2xl border border-gray-200 outline-none focus:border-brand-gold bg-white dark:bg-[#121212] font-bold text-brand-blue"
                                    value={asst.name}
                                    onChange={(e) => {
                                      const newList = [...content.assistants!];
                                ...
                                <div>
                                  ...
                                  <input
                                    className="w-full px-6 py-4 rounded-2xl border border-gray-200 outline-none focus:border-brand-gold bg-white dark:bg-[#121212] font-bold text-slate-500"
                                    value={asst.role}
                                    onChange={(e) => {
                                      const newList = [...content.assistants!];
                              ...
                              <div>
                                ...
                                <input
                                  className="w-full px-6 py-4 rounded-2xl border border-gray-200 outline-none focus:border-brand-gold bg-white dark:bg-[#121212] text-sm"
                                  value={asst.photoUrl || ""}
                                  onChange={(e) => {
                                    const newList = [...content.assistants!];
                              ...
                              <div>
                                <label className="block text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 mb-2">
                                  AI Behavior / System Prompt (Assistant ko
                                  kaam)
                                </label>
                                <textarea
                                  rows={4}
                                  className="w-full px-6 py-4 rounded-2xl border border-gray-200 outline-none focus:border-brand-gold bg-white dark:bg-[#121212] text-sm leading-relaxed"
                                ...
                                <p className="mt-2 text-[10px] text-gray-400 font-medium">
                                  This defines how the AI behaves. Be specific
                                  about its task (HR, Documentation, etc.)
                                </p>
                              </div>
                            </div>
                          </div>
