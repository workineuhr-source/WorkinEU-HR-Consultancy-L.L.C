    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 md:gap-6">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-300 text-xs md:text-base">
            Manage your blog posts, success stories, and updates.
          </p>
        </div>
        <button
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 bg-white dark:bg-[#121212] border border-gray-100 rounded-xl outline-none focus:border-brand-gold transition-all text-sm shadow-sm"
          value={searchQuery}
      ...
      {loading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="h-80 bg-white dark:bg-[#121212] rounded-2xl animate-pulse"
            ></div>
          ))}
        </div>
      ) : (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-400 mt-2 italic">
                  Upload an image or provide a URL. Leave blank for a
                  placeholder.
                </p>
              </div>
            </div>
