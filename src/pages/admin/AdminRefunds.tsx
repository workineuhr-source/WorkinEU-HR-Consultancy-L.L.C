    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-300">
          Manage candidate refund requests and installment payments.
        </p>
      </div>
              ...
              {loading ? (
                ...
                filteredCandidates.map((candidate) => (
                  ...
                  >
                    ...
                    <td className="px-8 py-6 text-sm font-medium text-gray-500 dark:text-gray-300">
                    ...
                    <td className="px-8 py-6">
                      <span
                        className={cn(
                          ...
                          candidate.refundRequest?.status === "pending"
                            ? "bg-orange-100 text-orange-600"
                            : candidate.refundRequest?.status === "proposed"
                              ? "bg-blue-100 text-blue-600"
                              : candidate.refundRequest?.status === "agreed"
                    ...
                    <td className="px-8 py-6">
                      <p className="text-sm font-bold text-brand-blue">
                        €{" "}
                        {candidate.refundRequest?.refundableAmount ||
                          candidate.refundRequest?.totalReceivedAmount}
                      </p>
                    ...
                    <td className="px-8 py-6 text-right">
                      <button
                        onClick={() => {
                          ...
                          setRiskAmount(
                            candidate.refundRequest?.riskAmount || 0,
                          );
                        }}
            ...
            >
              <div className="flex justify-between items-center mb-8">
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-300 text-sm">
                    ID: {selectedCandidate.refundRequest.id}
                  </p>
                </div>
                <button
                  onClick={() => setSelectedCandidate(null)}
              ...
              <div className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="p-6 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100">
                  ...
                  <div className="p-6 bg-gray-50 dark:bg-white/5 rounded-2xl border border-gray-100">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-bold text-brand-blue capitalize">
                          {selectedCandidate.refundRequest.status}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-500 dark:text-gray-300">
                        ...
                        <span className="font-bold text-brand-blue">
                          €{" "}
                          {selectedCandidate.refundRequest.totalReceivedAmount}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-500 dark:text-gray-300">
                        ...
                        <span className="font-bold text-brand-blue">
                          {new Date(
                            selectedCandidate.refundRequest.createdAt,
                          ).toLocaleDateString()}
                        </span>
                      </div>
                    </div>
                ...
                <div className="p-6 bg-red-50 rounded-2xl border border-red-100">
                  ...
                  <p className="text-red-700 text-sm italic">
                    "{selectedCandidate.refundRequest.reason}"
                  </p>
                </div>

                {/* Step 1: Propose Refund */}
                {(selectedCandidate.refundRequest.status === "pending" ||
                  selectedCandidate.refundRequest.status === "proposed") && (
                  <div className="bg-white p-8 rounded-3xl border-2 border-brand-blue/10 shadow-sm">
                    <h4 className="text-xl font-bold text-brand-blue mb-6 flex items-center gap-2">
                      ...
                      Step 1: Calculate & Propose Refund
                    </h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                      <div>
                        ...
                        <p className="text-[10px] text-gray-400 mt-1">
                          This amount will be deducted from the total paid
                          amount.
                        </p>
                      </div>
                ...
                {selectedCandidate.refundRequest.status === "agreed" && (
                  <div className="bg-purple-50 p-8 rounded-3xl border border-purple-100">
                    ...
                    <p className="text-purple-700 text-sm mb-8">
                      The candidate has agreed to the refund amount of{" "}
                      <span className="font-bold">
                        € {selectedCandidate.refundRequest.refundableAmount}
                      </span>
                      . You can now start the 90-day processing period which
                      will automatically generate 3 installments.
                    </p>
                    <button
                    ...
                    <div className="space-y-4">
                      {selectedCandidate.refundRequest.installments.map(
                        (inst, i) => (
                          <div
                            key={i}
                            className="flex items-center justify-between p-6 bg-white dark:bg-[#121212] rounded-2xl border border-gray-100 shadow-sm"
                          >
